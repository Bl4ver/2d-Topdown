export class Player {
    ...
    init(state, datas) {
        this.maxHp = Math.max(datas.playerUpgrades.maxHp.baseValue, state.player.maxHp * datas.playerUpgrades.maxHp.inc);
        this.hp = this.maxHp;
        this.speed = Math.max(datas.playerUpgrades.speed.baseValue, state.player.speed * datas.playerUpgrades.speed.inc);
        this.maxShield = Math.max(datas.playerUpgrades.maxShield.baseValue, (state.player.maxShield) * datas.playerUpgrades.maxShield.inc);
        this.shield = this.maxShield;
        this.shieldRegen = Math.max(datas.playerUpgrades.shieldRegen.baseValue, (state.player.shieldRegen) * datas.playerUpgrades.shieldRegen.inc);
        console.log(this)
        this.updateUI();
    }
